...
export default function BooksAdmin(props: Props) {
  ...
  const [yearOnEditInput, setYearOnEditInput] = useState();
    ...
    <>
      ...
      <label>
        ...
        <input
          value={yearInput}
          onChange={(event) => {
            setYearInput(event.currentTarget.value);
          }}
        />
      </label>
        ...
        return (
          <Fragment key={book.id}>
            ...
            <input
              ...
              disabled={!isBookOnEdit}
              onChange={(event) => {
                setYearOnEditInput(event.currentTarget.value);
              }}
            />
            <input
...
export async function getServerSideProps(context: GetServerSidePropsContext) {
  ...
  const initialBooksList = await getAllBooksWithLimit(3);
